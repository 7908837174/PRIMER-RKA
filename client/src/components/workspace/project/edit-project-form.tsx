...
export default function EditProjectForm(props: {
  ...
  return (
    <div className="w-full h-auto max-w-full bg-white dark:bg-[#1a1c1e] rounded-xl shadow-md p-5">
      <div className="h-full">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Button
              disabled={isPending}
              className="flex place-self-end  h-[40px] text-black  rounded-xl bg-gray-400 hover:bg-gray-600 font-semibold" 
              type="submit"
            >
