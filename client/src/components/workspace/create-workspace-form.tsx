...
export default function CreateWorkspaceForm({
  ...
  return (
    <main className="w-full flex flex-row min-h-[590px] h-auto max-w-full bg-white rounded-lg shadow-md dark:bg-[#1a1c1e]">
      <div className="h-full px-10 py-10 flex-1">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Button
              disabled={isPending}
              className="w-full h-[40px] text-white rounded-xl bg-black hover:bg-green-700 font-semibold"
              type="submit"
            >
