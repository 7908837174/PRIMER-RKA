...
export default function CreateTaskForm(props: {
  ...
  return (
    <div className="w-full h-auto max-w-full bg-red-100 dark:bg-[#1a1c1e] rounded-xl shadow-md p-5">
      <div className="h-full">
        ...
        <Form {...form}>
          <form className="space-y-3" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Button
              className="flex place-self-end  h-[40px] text-white font-semibold  rounded-xl bg-gray-600 hover:bg-gray-900"
              type="submit"
              disabled={isPending}
            >
