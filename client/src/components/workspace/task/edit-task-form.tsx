...
export default function EditTaskForm({ task, onClose }: { task: TaskType; onClose: () => void }) {
  ...
  return (
    <div className="w-full h-auto max-w-full bg-white rounded-xl shadow-md p-6 sm:p-8">
      <div className="h-full">
        <div className="mb-5 pb-2 border-b">
          <h1 className="text-xl font-semibold text-center sm:text-left bg-white">Edit Task</h1>
        </div>
        <Form {...form}>
          <form className="space-y-3" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <Button type="submit" className="w-full bg-black text-white rounded-xl hover:bg-green-700" disabled={isPending}>
